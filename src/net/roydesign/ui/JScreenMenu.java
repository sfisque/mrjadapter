...
public class JScreenMenu extends javax.swing.JMenu implements PropertyChangeListener
{
	...
	public void propertyChange(PropertyChangeEvent e)
	{
		if (e.getPropertyName().equals("enabled"))
		{
			...
			{
				setEnabled(true); /** @todo The UI is not repainted when useScreenMenuBar=true on Mac OS X */
			}
			else
			{
				int n = getMenuComponentCount();
				...
				setEnabled(false); /** @todo The UI is not repainted when useScreenMenuBar=true on Mac OS X */
			}
		}
	}
}
